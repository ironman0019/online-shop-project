    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="sidebar-nav">
            <section class="sidebar-nav-item">
                <span class="sidebar-nav-item-title"><a class="p-3" href="{{ route('profile.my-orders') }}">سفارش های من</a></span>
            </section>
            <section class="sidebar-nav-item">
                <span class="sidebar-nav-item-title"><a class="p-3" href="{{ route('address.index') }}">آدرس های من</a></span>
            </section>
            <section class="sidebar-nav-item">
